...
- The watcher rescans every 30 s; new and modified files are picked up automatically; deletes are reflected on the next pass
...
- Periodic scan, not fsnotify — there's a window of up to 30 s between save and indexing.
